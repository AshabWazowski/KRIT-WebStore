...
const Navbar = () => {
  ...
  return (
    <KritFlex
      padding="1rem 3%"
      sx={{ position: "sticky", top: "0", background: "#050408", zIndex:'10' }}
    >
      {/*DESKTOP VIEW */}
      <KritGap width="100%" sx={{ color: "whitesmoke" }}>
        {/*LOGO*/}
        <KritFlex
          sx={{ fontSize: "18px", cursor: "pointer", color: "#1f887c" }}
        >
          KRIT WebDev
        </KritFlex>
        ...
        {desktop ? (
          <>
            <KritGap
              gap="1.5rem"
              sx={{ color: "whitesmoke", fontWeight: "300", fontSize: "12px" }}
            >
          ...
          <IconButton
            sx={{ color: "whitesmoke", padding: "0.5rem" }}
      ...
      {!desktop && openSidebar && (
        ...
        >
          ...
          <KritGap flexDirection="column" gap="1.5rem" width="90%">
            <KritGap
              gap="1.5rem"
              sx={{ color: "#050408", fontWeight: "300", fontSize: "12px" }}
            >
              <span style={{ cursor: "pointer" }}>HOME</span>
              <span style={{ cursor: "pointer" }}>Services</span>
              <span style={{ cursor: "pointer" }}>HOW IT WORKS</span>
